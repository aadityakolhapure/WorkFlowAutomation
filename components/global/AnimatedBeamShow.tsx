...
export function AnimatedBeamDemo() {
    ...
    return (
        <div
            className="relative flex h-[500px] w-full items-center justify-center overflow-hidden rounded-lg border bg-background pb-40 md:shadow-xl"
            ref={containerRef}
        >
            <div className="flex size-full flex-col max-w-lg max-h-[200px] items-stretch justify-between gap-10">
                ...
                <div className="flex flex-row items-center justify-between">
                    ...
                    <Circle ref={div4Ref} className="size-16 bg-page-gradient bg-slate-900 border border-white/20 [box-shadow:0_-20px_80px_-20px_#8686f01f_inset]">
                        {/* <Icons.openai /> */}
                        <Image
                            src={Logo}
