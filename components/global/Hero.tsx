    ...
    return (
        <>
            <section className="flex relative flex-col gap-5 justify-center items-center mt-24 max-w-xl md:mt-32 md:max-w-2xl lg:max-w-3xl">
                ...
                >
                  Brainwave AI streamlines your workflows by automating tasks, routines, and processes, saving you time and effort. It efficiently manages your day-to-day operations, allowing you to focus on what matters most without getting bogged down by repetitive tasks.
                </motion.p>
