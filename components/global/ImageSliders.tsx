...
const AnimatedLogoCloud = () => {
  return (
    <div className="py-2 max-w-4xl scale-75">
      <p className="font-normal tracking-tighter text-2xl text-gray-100 bg-gradient-to-br from-zinc-400 via-zinc-300 to-zinc-700 bg-clip-text text-transparent text-center mt-4">
